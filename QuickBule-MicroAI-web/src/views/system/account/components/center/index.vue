        ...
        <a-col flex="350px">
          <a-form ref="formRef" :model="form" :rules="rules" layout="vertical">
            ...
            <a-form-item label="性别" name="gender">
              <enum-select class="form-item" v-model:value="form.gender" placeholder="请选择性别" enum-name="GENDER_ENUM" />
            </a-form-item>
            ...
            <a-form-item label="头像" name="avatar">
              ...
              >
                <div v-if="avatarUrl" class="avatar-container">
                  <img :src="avatarUrl" class="avatar-image" alt="avatar" @error="onAvatarError" />
                  <div class="overlay">
                    <span>更新头像</span>
                  </div>
                </div>
...
<script setup>
  ...
  // 头像加载失败时，回退到默认头像（防止后端返回的 fileKey / URL 已失效时显示破图）
