  ...
  <a-drawer v-model:open="showFlag" :width="1000" :title="title" placement="right" :destroyOnClose="true">
    <a-form class="qb-query-form">
      <a-row class="qb-query-form-row">
        ...
        <a-form-item label="执行结果" class="qb-query-form-item">
        ...
        <a-form-item label="执行时间" class="qb-query-form-item">
    ...
    <a-card size="small" :bordered="false" :hoverable="true">
      <a-row justify="end">
        <TableOperator class="qb-margin-bottom5" v-model="columns" :tableId="TABLE_ID_CONST.SUPPORT.JOB_LOG" :refresh="queryLogList" />
      </a-row>
