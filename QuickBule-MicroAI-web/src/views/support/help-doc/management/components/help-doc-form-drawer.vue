...
<template>
  <a-drawer
    ...
    @close="onClose"
    :destroyOnClose="true"
    :wrapClassName="help-doc-drawer-wrapper"
    :zIndex="1000"
  >
    <a-form ref="formRef" :model="formData" :rules="formRules" :label-col="{ span: 3 }" :wrapper-col="{ span: 20 }">
      ...
      <a-form-item label="附件">
        <Upload
          ...
          :maxUploadSize="10"
          :folderType="FILE_FOLDER_TYPE_ENUM.HELP_DOC.value"
          buttonText="上传附件"
          listType="text"
          extraMsg="最多上传10个附件"
...
<style lang="less">
  ...
  .help-doc-drawer-wrapper .w-e-toolbar {
    position: relative;
    z-index: 1001 !important;
  }

  .help-doc-drawer-wrapper .w-e-bar-item {
    pointer-events: auto !important;
  }

  .help-doc-drawer-wrapper .w-e-bar-item button {
    pointer-events: auto !important;
    cursor: pointer !important;
  }

  .help-doc-drawer-wrapper .w-e-panel-container {
    z-index: 10050 !important;
    pointer-events: auto !important;
  }

  .help-doc-drawer-wrapper .w-e-select-list {
    z-index: 10050 !important;
    pointer-events: auto !important;
  }

  .help-doc-drawer-wrapper .w-e-select-list .w-e-select-option {
    pointer-events: auto !important;
    cursor: pointer !important;
  }

  .help-doc-drawer-wrapper .w-e-full-screen-container {
    z-index: 99999 !important;
  }

  .help-doc-drawer-wrapper .w-e-bar-tooltip {
    z-index: 10050 !important;
  }

  .help-doc-drawer-wrapper .w-e-emotion-panel {
    z-index: 10050 !important;
  }

  .help-doc-drawer-wrapper .w-e-text-container {
    pointer-events: auto !important;
  }
</style>
