...
<template>
  <a-form class="qb-query-form">
    <a-row class="qb-query-form-row">
      <a-form-item label="关键字" class="qb-query-form-item" style="margin-right: 20px">
        <a-input style="width: 240px" v-model:value.trim="queryForm.searchWord" placeholder="反馈内容/创建人" />
      </a-form-item>
      <a-form-item label="创建日期" class="qb-query-form-item" style="margin-right: 20px">
        <a-range-picker
  ...
  <a-card size="small">
    <a-table ref="tableRef" rowKey="feedbackId" :dataSource="tableData" :columns="tableColumns" :pagination="false" :loading="tableLoading" size="small" bordered>
